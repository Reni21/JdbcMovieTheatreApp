...
Уровни доступа: аноним, клиент, администратор.

## Функционал доступный на любом уровне:
...
## Функционал доступный пользователям вошедшим в систему:

7.  Возможномть выйти из системы (LogOutCommand) +

## Функционал доступный на уровне клиент:
...
## Функционал доступный на уровне администратор:
