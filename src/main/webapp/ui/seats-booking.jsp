        ...
        -->
            <div class="content-card">
                ...
                <div class="content-card__container">
                    ...
                    <div class="hall-title">${session.getFormattedDate()} ${session.getFormattedTime()} <img class="clock"
                                                                                                           aria-hidden="true"
                            ...
                            <c:forEach items="${bookedSeats.entrySet()}" var="entrySetSeats">
                                <div class="seatRow">
                                    ...
                                    <c:forEach items="${entrySetSeats.getValue()}" var="seat">
                                        <div id="${seat.row}_${seat.place}" role="checkbox" value="${session.price}"
                    ...
                    <div class="checkout col-lg-offset-6">
                        ...
                        <button id="btnCheckout" name="btnCheckout"
                            ...
                            ${user == null ? 'Log in to book tickets' : 'Book tickets'}</button>
                    </div>
                </div>
            </div>
        </main>
